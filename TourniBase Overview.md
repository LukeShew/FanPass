...
- Parent phone mockup uses a visibly larger scaled TourniBase logo lockup in the app header, tuned status-bar positioning with a larger time, iOS-style cell/battery indicators, and a smaller standard bell notification icon
- Parent phone mockup menu uses a smaller custom navy dot-and-pill list icon
