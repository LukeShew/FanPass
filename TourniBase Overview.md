...
- Trial device framing is active: the director and coach dashboards are both shown inside iPad Pro-style frames with corrected power/volume controls and bottom home indicators, while keeping the existing dashboard content
