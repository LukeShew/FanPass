...
- Site header uses the primary TourniBase logo lockup, padding, and contact button height
...
- Current production logo source: `TourniBase logos/tournibase-primary-logo-lockup.png`
