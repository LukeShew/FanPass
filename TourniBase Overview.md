...
- Parent page uses a realistic iPhone-style pass mockup with TourniBase branding, paid status, entrance info, a less uniform QR-style code, a single Next pass row, and an iPhone-style home indicator
